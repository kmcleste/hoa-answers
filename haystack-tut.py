...
from haystack.utils import convert_files_to_dicts, print_answers, launch_es
...
def tutorial1_basic_qa_pipeline():
    ...
    dicts = convert_files_to_dicts(dir_path='/Users/kmclester/Documents/hoa-topics/text', split_paragraphs=True)
    ...
    prediction = pipe.run(
        query="Are there any events where any rental agreement or lease relieve or release any Owner from the obligation to pay?", params={"Retriever": {"top_k": 10}, "Reader": {"top_k": 5}}
    )
